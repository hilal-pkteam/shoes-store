<div class="container flex flex-col-reverse md:flex-row overflow-x-hidden text-center md:text-start">
      ...
      <div class="child w-full md:w-3/5 lg:w-2/5 md:my-auto md:mx-12 px-8">
         ...
         <p class="my-3 text-gray-700 font-medium">Trusted platform for selling shoes and specially Chappal. Direct customer-to-customer interactions. Find your perfect shoes now</p>
      ...
      <img class="w-full md:w-2/5 lg:w-3/5" src="{{ asset('images/banner-image.png') }}" alt="banner-image" loading="lazy">
</div>
